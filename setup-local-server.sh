...
case $choice in
    1)
        ...
        echo "   同一ネットワーク: http://$LOCAL_IP:$AVAILABLE_PORT"
        echo ""
        echo "💡 他の端末からのアクセス方法:"
        echo "   1. 同一Wi-Fiネットワークに接続"
        echo "   2. ブラウザで http://$LOCAL_IP:$AVAILABLE_PORT にアクセス"
        echo ""
        echo "🔧 ファイアウォール設定:"
        echo "   macOS: システム環境設定 > セキュリティとプライバシー > ファイアウォール"
        echo "   ポート $AVAILABLE_PORT の受信接続を許可してください"
        echo ""
    ...
    2)
        ...
        echo "   同一ネットワーク: http://$LOCAL_IP:3000"
        echo ""
        echo "💡 他の端末からのアクセス方法:"
        echo "   1. 同一Wi-Fiネットワークに接続"
        echo "   2. ブラウザで http://$LOCAL_IP:3000 にアクセス"
        echo "   3. QRコード: http://$LOCAL_IP:3000/api/qr"
        echo ""
        echo "🔧 ファイアウォール設定:"
        echo "   macOS: システム環境設定 > セキュリティとプライバシー > ファイアウォール"
        echo "   ポート 3000 の受信接続を許可してください"
        echo ""
        node server.js
        ;;
    3)
